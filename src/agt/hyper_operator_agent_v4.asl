...
// Beliefs from signifier
hasAction("ToggleCommand", "https://saref.etsi.org/core", "https://www.w3.org/2019/wot/json-schema#BooleanSchema", "lightbulb1").
hasAction("ToggleCommand", "https://saref.etsi.org/core", "https://www.w3.org/2019/wot/json-schema#BooleanSchema", "lightbulb2").

{ namespace(saref, "https://saref.etsi.org/core") }
...
+!turnOnLight(ThingName, WorkspaceName)
    ...
    <-
        ...
        saref::toogleCommand([true])[artifact_name(ThingName)]
        .
